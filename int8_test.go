...
// Chunk
func TestInt8Slice_Chunk(t *testing.T) {
	tests := []struct {
		name     string
		size     int
		slice    []int8
	...
	}{
		{
			...
			size:     2,
			slice:    []int8{1, 2, 5, 11, 13, 15},
			expected: [][]int8{{1, 2}, {5, 11}, {13, 15}},
		},
		{
			name:     "chunks of 2 with remainder",
			size:     2,
			slice:    []int8{1, 2, 5, 11, 13, 15, 17},
			expected: [][]int8{{1, 2}, {5, 11}, {13, 15}, {17}},
		},
		{
			name:     "chunks of 100",
			size:     100,
	...
	for _, test := range tests {
		t.Run(test.name, func(t *testing.T) {
			out := Int8Slice(test.slice).Chunk(test.size)
